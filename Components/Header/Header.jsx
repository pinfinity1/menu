    ...
    >
      {loading ?
        ...
        <div className="flex items-center gap-4">
          <div className="w-[56px] h-[48px] bg-gray-100 animate-pulse rounded transition-all duration-150">
          </div>
          <div className="w-[64px] h-[48px] bg-gray-100 animate-pulse rounded transition-all duration-150">
          </div>
          <div className="w-[48px] h-[48px] bg-gray-100 animate-pulse rounded transition-all duration-150">
          </div>
          <div className="w-[96px] h-[48px] bg-gray-100 animate-pulse rounded transition-all duration-150">
          </div>
        </div>
          </>) :
          (<>{category?.map((cat) => {
